...
const ClientManagementPage: React.FC = () => {
  ...
  const loadClients = async () => {
    try {
      setLoading(true);
      // Get all clients without parameters
      const allClients = await clientService.getAllClients();
      
      // Calculate total count from the full array
      ...
      if (orderBy) {
        sortedClients.sort((a, b) => {
          ...
          const aString = String(aValue as string | number).toLowerCase();
          const bString = String(bValue as string | number).toLowerCase();
      ...
      const endIndex = Math.min(startIndex + rowsPerPage, sortedClients.length);
